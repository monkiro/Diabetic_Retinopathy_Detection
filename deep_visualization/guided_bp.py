...
def start():
    I = Image.open('D:\\DL_Lab_P1\\dataset_processed\\images\\showcam\\IDRiD_049.jpg').convert('RGB')
    ...
    result1 = guided_bp.visualize(tensor, None)
    result = normalize(result1)
    result = result[:, :, ::-1] * 255
    cv2.imwrite('D:\\DL_Lab_P1\\test_aligned_deconv2.jpg', result)
    return result1
